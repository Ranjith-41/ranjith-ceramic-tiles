...
function Testimonials() {
  const testimonials = [
    {
      name: 'Amit Sharma',
      feedback: 'The quality of the tiles from Ranjith Ceramics is unmatched! Our home looks beautiful, thanks to their products.',
      image: as,
    },
    {
      name: 'Riya Verma',
    ...
    {
      name: 'Vikram Singh',
      feedback: 'Ranjith Ceramics provided us with the perfect bathtub. Their product quality and customer support are excellent!',
      image: vs,
    },
    {
      name: 'Ashutosh Pradhan',
      feedback: 'I was impressed with the tile designs and durability. Ranjith Ceramics exceeded my expectations, and I love how it transformed my space!',
      image: ashutosh,
    },
    {
      name: 'Krishna Kashyap',
      feedback: 'The flooring options at Ranjith Ceramics were amazing. Our new floor looks luxurious, and the installation was smooth and professional.',
      image: krishna,
    },
    {
      name: 'Ayush',
    ...
    {
      name: 'Rishank',
      feedback: 'Ranjith Ceramics offers unique and beautiful options! The team helped us pick the right products, and our kitchen looks fantastic!',
      image: rishank,
    }
